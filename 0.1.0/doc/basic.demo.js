...
/******/ 	__webpack_require__.p = "/trigger.react/0.1.0";
/******/
...
var Trigger = __webpack_require__("./lib/index.js");
        ...
        value: function render() {
            return __webpack_require__("./node_modules/react/index.js").createElement(
                ...
                __webpack_require__("./node_modules/react/index.js").createElement(
                    ...
                    {
                        trigger: 'click',
                        popup: function popup(self) {
                            return __webpack_require__("./node_modules/react/index.js").createElement(
                                'div',
                                { style: { width: 100, height: 100, background: 'skyblue' } },
                                __webpack_require__("./node_modules/react/index.js").createElement(
                                    'div',
                                    { style: { width: 200, padding: 30, border: '1px solid red' } },
                                    __webpack_require__("./node_modules/react/index.js").createElement(
                                        'button',
                                        null,
                                        'button'
...
var _reactDefaultvalue = __webpack_require__("./node_modules/react-defaultvalue/lib/index.js");

var _reactDefaultvalue2 = _interopRequireDefault(_reactDefaultvalue);

var _position = __webpack_require__("./node_modules/position.react/lib/index.js");
...
var Trigger = (_temp = _class = function (_Component) {
    ...
    _createClass(Trigger, [{
        ...
        key: "render",
        value: function render() {
            var ref = _util2.default.ref;
            var self = this;
            var extendProps = {};
            var isHTMLElement = typeof self.props.children.type === 'string';
            switch (self.props.trigger) {
                case 'click':
                    extendProps.onClick = function (e) {
                    ...
                    break;
                case 'hover':
                    extendProps.onMouseEnter = function (e) {
            ...
            var domProps = (0, _reactSpreadProps2.default)(self.props, extendProps, {
            ...
            if (isHTMLElement) {
                ...
                node = (0, _react.cloneElement)(self.props.children, domProps);
                self.$refs = self.$refs || {};
                self.$refs.root = node;
            } else {
                node = __webpack_require__("./node_modules/react/index.js").createElement(
                    "span",
                    domProps,
                    self.props.children
                );
            ...
            return __webpack_require__("./node_modules/react/index.js").createElement(
                ...
                null,
                node,
                self.getValue() ? __webpack_require__("./node_modules/react/index.js").createElement(
                    _position2.default,
                    {
                    ...
                    typeof self.props.popup === 'function' ? self.props.popup(self) : self.props.popup
                ) : null
            );
        }
    }]);
    ...
    this.show = function () {
        _this2.emitChange(true);
    };

    this.hide = function () {
        _this2.emitChange(false);
    };

    this.handleClick = function (e) {
        var self = _this2;
        if (!_util2.default.contains(self.$refs.position.$refs.root, e.target)) {
            self.hide();
        }
    };
    ...
    this.emitChange = function (value) {
        var self = _this2;
...
__webpack_require__("./lib/props.js").default(Trigger);
...
/***/ "./node_modules/face-position/lib/defaultProps.js":
/***/ (function(module, exports, __webpack_require__) {
...
exports.default = function () {
    return {
        ...
        onPosition: function onPosition(position, el, target, offsetParent) {
            return {
                x: 0,
                y: 0
            };
...
/***/ "./node_modules/face-position/lib/getBaseOnOffset.js":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/face-position/lib/getBorderWidth.js":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/face-position/lib/getPositionParent.js":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/face-position/lib/index.js":
/***/ (function(module, exports, __webpack_require__) {

"use strict";


var _getPositionParent = __webpack_require__("./node_modules/face-position/lib/getPositionParent.js");

var _getPositionParent2 = _interopRequireDefault(_getPositionParent);

var _getBorderWidth = __webpack_require__("./node_modules/face-position/lib/getBorderWidth.js");

var _getBorderWidth2 = _interopRequireDefault(_getBorderWidth);

var _defaultProps = __webpack_require__("./node_modules/face-position/lib/defaultProps.js");

var _defaultProps2 = _interopRequireDefault(_defaultProps);

var _getBaseOnOffset = __webpack_require__("./node_modules/face-position/lib/getBaseOnOffset.js");
...
var domPos = function domPos(options) {
    ...
    requestAnimationFrame(function () {
        ...
        // set baseOn Offse
        options.el.$overallWidth = options.el.getBoundingClientRect().right - options.el.getBoundingClientRect().left;
        positionLeft = (0, _getBaseOnOffset2.default)(positionLeft, options.baseOn.el[0], options.el.$overallWidth, 'el');
        options.el.$overallHeight = options.el.getBoundingClientRect().bottom - options.el.getBoundingClientRect().top;
        positionTop = (0, _getBaseOnOffset2.default)(positionTop, options.baseOn.el[1], options.el.$overallHeight, 'el');
        options.target.$overallWidth = options.target.getBoundingClientRect().right - options.target.getBoundingClientRect().left;
        options.target.$overallHeight = options.target.getBoundingClientRect().bottom - options.target.getBoundingClientRect().top;
        positionLeft = (0, _getBaseOnOffset2.default)(positionLeft, options.baseOn.target[0], options.target.$overallWidth);
        positionTop = (0, _getBaseOnOffset2.default)(positionTop, options.baseOn.target[1], options.target.$overallHeight);
        if (offsetParentEl.tagName.toUpperCase() === 'HTML') {
...
/***/ "./node_modules/position.react/lib/index.js":
/***/ (function(module, exports, __webpack_require__) {
...
var _facePosition = __webpack_require__("./node_modules/face-position/lib/index.js");

var _facePosition2 = _interopRequireDefault(_facePosition);
...
var Position = (_temp = _class = function (_Component) {
    ...
    _createClass(Position, [{
        ...
        value: function render() {
            ...
            return _reactDom2.default.createPortal(__webpack_require__("./node_modules/react/index.js").createElement(
                "div",
                _extends({ ref: ref('root') }, domProps),
                self.props.children
            ), document.body);
        }
    }]);
...
__webpack_require__("./node_modules/position.react/lib/props.js").default(Position);
...
/***/ "./node_modules/position.react/lib/props.js":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/react-defaultvalue/lib/index.js":
/***/ (function(module, exports, __webpack_require__) {
